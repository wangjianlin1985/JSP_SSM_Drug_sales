	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="product_mainPhoto" class="col-md-2 text-right">商品图片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="product_productNum" class="col-md-2 text-right">商品库存:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productNum" name="product.productNum" class="form-control" placeholder="请输入商品库存">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="product_recommandFlag" class="col-md-2 text-right">是否推荐:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_recommandFlag" name="product.recommandFlag" class="form-control" placeholder="请输入是否推荐">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_recipeFlag" class="col-md-2 text-right">是否处方药:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_recipeFlag" name="product.recipeFlag" class="form-control" placeholder="请输入是否处方药">
					 </div>
				  </div>
				  <div class="form-group">
