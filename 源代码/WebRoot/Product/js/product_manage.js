...
function initProductManageTool() {
	product_manage_tool = {
		...
		search: function() {
			...
			queryParams["recommandFlag"] = $("#recommandFlag").val();
			queryParams["recipeFlag"] = $("#recipeFlag").val();
				...
				$.ajax({
					...
					success : function (product, response, status) {
						...
						if (product) { 
							...
							$("#product_productNum_edit").validatebox({
								required : true,
								validType : "integer",
							...
							$("#product_recommandFlag_edit").validatebox({
								required : true,
								missingMessage : "请输入是否推荐",
							});
							$("#product_recipeFlag_edit").val(product.recipeFlag);
							$("#product_recipeFlag_edit").validatebox({
								required : true,
								missingMessage : "请输入是否处方药",
							});
