...
<%
    ...
    String recipeFlag = (String)request.getAttribute("recipeFlag"); //是否处方药查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
			...
			<div class="form-group">
				<label for="recipeFlag">是否处方药:</label>
				<input type="text" id="recipeFlag" name="recipeFlag" value="<%=recipeFlag %>" class="form-control" placeholder="请输入是否处方药">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="product_mainPhoto_edit" class="col-md-3 text-right">商品图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productNum_edit" class="col-md-3 text-right">商品库存:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productNum_edit" name="product.productNum" class="form-control" placeholder="请输入商品库存">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="product_recipeFlag_edit" class="col-md-3 text-right">是否处方药:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_recipeFlag_edit" name="product.recipeFlag" class="form-control" placeholder="请输入是否处方药">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (product, response, status) {
			if (product) {
				...
				$("#product_productNum_edit").val(product.productNum);
				$("#product_price_edit").val(product.price);
				$("#product_recommandFlag_edit").val(product.recommandFlag);
				$("#product_recipeFlag_edit").val(product.recipeFlag);
