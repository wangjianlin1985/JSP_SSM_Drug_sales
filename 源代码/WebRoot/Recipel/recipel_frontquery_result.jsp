...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Recipel/frontlist">处方信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Recipel/recipel_frontAdd.jsp" style="display:none;">添加处方</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<recipelList.size();i++) {
            		...
            		Recipel recipel = recipelList.get(i); //获取到处方对象
            		String clearLeft = "";
            		if(i%4 == 0) clearLeft = "style=\"clear:left;\"";
			%>
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Recipel/<%=recipel.getRecipelId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=recipel.getRecipelPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		处方id:<%=recipel.getRecipelId() %>
			     	</div>
			     	<div class="field">
	            		上传用户:<%=recipel.getUserObj().getName() %>
			     	</div>
			     	<div class="field">
	            		处方备注:<%=recipel.getRecipelMemo() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="recipelQueryForm" id="recipelQueryForm" action="<%=basePath %>Recipel/frontlist" class="mar_t15">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;处方信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="recipel_recipelId_edit" class="col-md-3 text-right">处方id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="recipel_recipelId_edit" name="recipel.recipelId" class="form-control" placeholder="请输入处方id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="recipel_recipelPhoto_edit" class="col-md-3 text-right">处方照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="recipel_recipelMemo_edit" class="col-md-3 text-right">处方备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="recipel_recipelMemo_edit" name="recipel.recipelMemo" rows="8" class="form-control" placeholder="请输入处方备注"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
